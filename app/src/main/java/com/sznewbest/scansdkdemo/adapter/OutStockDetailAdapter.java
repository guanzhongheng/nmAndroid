...
public class OutStockDetailAdapter extends BaseAdapter {
    ...
    public OutStockDetailAdapter(Context context, List<OutStockDetailVo> list, String outCode){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.item_variety.setText("品种:"+StringUtils.ifNull(item.getProdVarietyVal()));
        holder.item_cgy_code.setText("类别:"+StringUtils.ifNull(item.getProdCgyVal()));
        holder.item_weight.setText("重量:"+ StringUtils.ifNull(item.getProdWeight())+"kg");
        holder.item_lw.setText("长*宽:"+ StringUtils.ifNull(item.getItemLenth())+"m*"+StringUtils.ifNull(item.getItemWidth())+"m");
        holder.item_color.setText("颜色:"+StringUtils.ifNull(item.getProdColorVal()));
        ...
        normalDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        OkGo.<String>delete(NmerpConnect.DELETE_PROD_BY_CODE)
                                .tag(this)
