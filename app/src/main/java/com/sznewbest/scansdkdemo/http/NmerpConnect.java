...
public class NmerpConnect {
    ...
    // public static final String BASE_URL = "http://192.168.0.106:8080/ls";
    ...
    public static final String DO_OUT_AUTO_STOCK = append("/outStock/app/car/addProd");
    ...
    public static final String DETAIL_LIST = append("/outStock/app/outStock/prods");
